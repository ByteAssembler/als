export const itTranslations = {
	...
	cookieBanner: {
		message: "Questo sito utilizza i cookie. Maggiori informazioni nella nostra ",
		privacyLinkText: "informativa sulla privacy",
		dontShowAgain: "Non mostrare più questo banner in futuro",
		acceptAll: "Accetta tutti",
		acceptEssential: "Accetta solo quelli essenziali"
	},
	footer: {
